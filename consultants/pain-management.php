...
<html lang="en-gb">
  <head>
    ...
    <title>CPGL | Comfortcare Partnership Group Limited</title>
    ...
    <meta property="og:url" content="https://www.comfortcaregroups.co.uk/consultants/pain-management"/>
    <meta property="og:title" content="CPGL | Comfortcare Partnership Group Limited"/>
    <meta property="og:site_name" content="CPGL | Comfortcare Partnership Group Limited"/>
    <meta property="og:type" content="article"/>

    <link href="https://www.comfortcaregroups.co.uk/consultants/pain-management" rel="canonical">
                    ...
                    <ul class="navbar-nav">
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/pregnancy-ultrasound" class="nav-link dropdown-toggle">Antenatal Care</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/antenatal-scans-and-private-births/private-births" class="nav-link">Private Births</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/antenatal-scans-and-private-births/private-antenatal-care" class="nav-link">Private Antenatal Care Package</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/pregnancy-ultrasound/antenatal-scans" class="nav-link">Antenatal Scans</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/antenatal-scans-and-private-births/non-invasive-prenatal-testing-nipt" class="nav-link">Non-Invasive Prenatal Testing (NIPT)</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/pregnancy-ultrasound/invasive-prenatal-testing" class="nav-link">Invasive Prenatal Testing</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/pregnancy-ultrasound/group-b-strep-test" class="nav-link">Group B Strep Test</a>
                              </li>                                                              
                                                                                      </ul>
                                                      </li>
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/ultrasound" class="nav-link dropdown-toggle">Ultrasound</a>
                                ...
                                <a href="/ultrasound/gynaecology-ultrasound" class="nav-link">Gynaecological Scans</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/ultrasound/follicle-tracking-scan" class="nav-link">Follicle Tracking Scan </a>
                              </li>                                                              
                                                          <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/private-gp" class="nav-link dropdown-toggle">Private GP</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/private-gp/consultations" class="nav-link">Consultations</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/private-gp/health-screens" class="nav-link">Health Screens</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/private-gp/hayfever-injection" class="nav-link">Hayfever Injection</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/private-gp/immunisations-and-travel-vaccinations" class="nav-link">Immunisations and Travel Vaccinations</a>
                              </li>                                                              
                                                                                      </ul>
                                                      </li>
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/covid-tests" class="nav-link dropdown-toggle">Covid Tests</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/covid-tests/proof-of-recovery-from-covid-19-certificate" class="nav-link">Proof of recovery from Covid-19 Certificate</a>
                              </li>                                                              
                                                                                      </ul>
                                                      </li>
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/consultants" class="nav-link dropdown-toggle">Consultants</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/consultants/breast-surgeon" class="nav-link">Consultant Breast Surgeon</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/cardiology" class="nav-link">Cardiology</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/contraceptive" class="nav-link">Contraceptive</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/dermatology" class="nav-link">Dermatology</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/ent-ear-nose-throat" class="nav-link">Ear, Nose and Throat</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/fertility" class="nav-link">Fertility</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/general-surgery-and-colorectal" class="nav-link">General Surgery and Colorectal</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/gynaecology" class="nav-link">Gynaecology</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/orthopaedic" class="nav-link">Orthopaedic </a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/sexual-health" class="nav-link">Sexual Health</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/paediatrics" class="nav-link">Paediatrics </a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/physiotherapy" class="nav-link">Physiotherapy</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/urogynaecology" class="nav-link">UroGynaecology</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/consultants/urology" class="nav-link">Urology</a>
                              </li>                                                              
                                                                                      </ul>
                                                      </li>
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/tests-diagnostics" class="nav-link dropdown-toggle">Tests and Diagnostics</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/tests-diagnostics/cardiology-tests" class="nav-link">Cardiology Tests</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/tests-diagnostics/allergy" class="nav-link">Allergy Testing</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/tests-diagnostics/genetic-testing" class="nav-link">Genetic Testing</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/tests-diagnostics/cancer" class="nav-link">Cancer</a>
                              </li>                                                              
                                                          <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/sexual-health" class="nav-link dropdown-toggle">Sexual Health</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/sexual-health-testing" class="nav-link">Sexual Health Testing</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/sexual-health/erectile-dysfunction" class="nav-link">Erectile Dysfunction</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/sexual-health/sexual-function-sexual-satisfaction-and-sexual-pleasure" class="nav-link">Sexual function, sexual satisfaction and sexual pleasure</a>
                              </li>                                                              
                                                                                      </ul>
                                                      </li>
                          ...
                          <li class="nav-item">
                            <a href="https://www.comfortcaregroups.co.uk/aesthetics" class="nav-link dropdown-toggle">Aesthetics</a>
                                                          ...
                                                          <li class="nav-item">
                                <a href="/aesthetics/anti-wrinkle-treatments" class="nav-link">Anti-Wrinkle Treatments</a>
                              </li>                                                              
                                                          <li class="nav-item">
                                <a href="/aesthetics/dermal-fillers" class="nav-link">Dermal Fillers</a>
                              </li>                                                              
                                                                                      </ul>
                                                      </li>
  ...
  <div class="container">
    <div class='row mt-4'>
       <div class='col-lg-12 text-center'>
           <h1 class="text-purple" style="padding: 30px 0px">404 - Page Not Found</h1>
              ...
              <div class="footer-item">
                <div class="footer-contact">                    
                    <ul>
                      ...
                      <li>
                        The Blades Centre John Street Sheffield S2 4SW
                      </li>
                    </ul>
                </div>
                </div>
