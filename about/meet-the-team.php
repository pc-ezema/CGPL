...
<head>
    ...
    <title>Meet Our Team at CPGL Group of Partnership Limited</title>
    ...
    <meta property="og:title" content="Meet Our Team at CPGL Group of Partnership Limited"/>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <h6 class="text-muted">Speciality Doctor in Obstetrics and Gynaecology</h6>  
    </div>
  </div>
</div>        
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <h6 class="text-muted">Sonographer</h6>  
    </div>
  </div>
</div>        
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h5 class="text-purple">Dr Adeline Afong</h5>
      <h6 class="text-muted">General Practitioner</h6>  
    </div>
  </div>
</div>         -->
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <h6 class="text-muted">Director of Operations & Business Development</h6>  
    </div>
  </div>
</div>        
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h5 class="text-purple">Alison Wisedale</h5>
...
<!--             
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h5 class="text-purple">Stef Dinu</h5>
      <h6 class="text-muted">HCA</h6>  
    </div>
  </div>
</div>         -->
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h5 class="text-purple">Lara Taylor</h5>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h5 class="text-purple">Freddie George</h5>
...
<!--             
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <h5 class="text-purple">Zach Rock</h5>
            ...
            <div class="col-sm-12 col-lg-3">
              <div class="footer-item">
                <div class="footer-quick">
                  <h3>Learn More</h3>
                  <ul>
                      <li><a class="text-white" href="meet-the-team.php">Meet Our Team</a></li>
